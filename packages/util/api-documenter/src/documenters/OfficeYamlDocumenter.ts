...
export class OfficeYamlDocumenter extends YamlDocumenter {
  ...
  private _apiSetUrls: Record<string, string> = {
    ...
    OneNote:
      "/javascript/api/requirement-sets/onenote/onenote-api-requirement-sets",
    Outlook:
      "/javascript/api/requirement-sets/outlook/outlook-api-requirement-sets",
    PowerPoint:
      "/javascript/api/requirement-sets/powerpoint/powerpoint-api-requirement-sets",
    Visio:
  ...
  protected onCustomizeYamlItem(yamlItem: IYamlItem): void {
    ...
    const snippets: string[] | undefined =
      this._snippetsAll[nameWithoutPackage];
    if (snippets) {
